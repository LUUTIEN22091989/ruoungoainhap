...
<!-- //calendar -->
 <!-- Ionicons -->
  <link rel="stylesheet" href="/backend/Ionicons/css/ionicons.min.css">
<!-- //font-awesome icons -->
...
<link rel="stylesheet" type="text/css" href="/backend/AdminLTE.min.css">
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{ route('get.admin.home') }}">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.home-frontend.index')}}">Liệt kê </a></li>
                        <li><a href="{{ route('admin.home-frontend.create')}}">Thêm mới</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.user.index')}}">Liệt kê thành viên</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.index')}}">Liệt kê</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{ route('admin.category.index')}}">Liệt kê danh mục</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{ route('admin.brand.index') }}">Liệt kê thương hiệu</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.country.create') }}">Thêm xuất xứ</a></li>
                        <li><a href="{{ route('admin.country.index') }}">Liệt kê xuất xứ</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.rating.index') }}">Liệt kê rating</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.transaction.index') }}">Liệt kê đơn hàng</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.cuppon.create') }}">Thêm cuppon</a></li>
                        <li><a href="{{ route('admin.cuppon.index') }}">Liệt kê cuppon</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('admin.menu.create') }}">Thêm danh mục</a></li>
                        <li><a href="{{ route('admin.menu.index') }}">Liệt kê danh mục</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
    ...
    //thông báo khi xóa dữ liệu
       $(".js-delete-confirm").click(function(event){
              ...
              let URL = $(this).attr('href');
               $.confirm({ /// hiện thông báo khi nhấn delete
                title: 'Bạn có chắc chắn muốn xóa ko?',
                content: 'Hãy nhấn Ok để xóa hoặc Cancel để hủy',
                type: 'red',
                buttons: {   
                    ok: {
                        text: "ok!",
