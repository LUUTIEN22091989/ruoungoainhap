                        ...
                        <form role="form" action="" method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="s_title" name="s_title" placeholder="Tên ..." value="{{ $static->s_title}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                      ...
                                      <textarea cols="12" rows="5" class="form-control" id="ckeditor1" name="s_content" placeholder="Nội dung sản phẩm">{{ $static->s_content}}</textarea>
                                </div>
