...
<div class="row" style="margin-top: 20px;">
     <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-3 text-center" style="border: 1px solid #f3e8e8;padding: 5px;">
                    <a href="{{ request()->fullUrlWithQuery(['danh_muc' => Str::slug($cat->c_name).'-'.$cat->id]) }}" style="font-size: 20px;">
                        <img style="width: 20%;height: 60px;" class="img-lazyload" data-original="{{ asset($cat->c_avatar) }}">
    ...
    <div class="col-sm-12 search-price" style="display: flex;margin-top: 20px;">
        <p>Lọc theo giá:</p>
        <ul style="display: flex;">
             <li class="{{ Request::get('price') == 0 ? "active" : "" }}">
                 <a href="{{ request()->fullUrlWithQuery(['price' => 0]) }}">Tất cả giá&nbsp&nbsp&nbsp&nbsp</a>
              </li>
              <li class="{{ Request::get('price') == 7 ? "active" : "" }}">
                 <a href="{{ request()->fullUrlWithQuery(['price' => 7]) }}">Dưới 3 triệu&nbsp&nbsp&nbsp&nbsp</a>
              </li>
            @for($i =1; $i <= 5; $i++)
             <li class="{{ Request::get('price') == $i ? "active" : "" }}">
                 <a href="{{ request()->fullUrlWithQuery(['price' => $i]) }}">Từ  {{ $i * 3}}-{{ ($i * 3) + 3}} triệu&nbsp&nbsp&nbsp&nbsp</a>
             </li>
            @endfor
              <li class="{{ Request::get('price') == 6 ? "active" : "" }}">
                 <a href="{{ request()->fullUrlWithQuery(['price' => 6]) }}">Trên 18 triệu</a>
              </li>
         </ul>
    </div>
    <div class="col-sm-12 padding-right" style="margin-top: 20px;">
        <div class="features_items">
            <!--features_items-->
            <h2 class="title text-center" style="font-size: 20px">Thương hiệu {{ $brand->b_name }} - {{ $products->total() }} Sản phẩm</h2>
