...
<div class="row">
	            <div class="">
						<ol class="breadcrumb">
						  ...
						  <li><a href="{{ route('get.news.list') }}">Tin tức về rượu</a></li>
						  <li class="active">{{ $article->a_name }}</li>
						</ol>
		        </div>
				<div class="col-sm-9">
					<div class="blog-post-area">
						<h2 class="title text-center">{{ $article->a_name }}</h2>
						<div class="single-blog-post">
							...
							<p>{!! $article->a_description!!}</p> <br>

							<p>{!! $article->a_content!!}</p> <br>
						</div>
					</div><!--/blog-post-area-->
					<!-- bình luận -->
					<h3>Mời bình luận về bài viết này: </h3>
